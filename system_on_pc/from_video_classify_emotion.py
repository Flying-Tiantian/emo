...
Sample_rate = 3
VIDEO_PATH = '/data/short_movie/zy_short_movie/video_zy_eye/test/'
SAVE_PATH = './result_zy/'

SAVE_KMEANS_PATH = './features_resnet20_7_pics_zy/'
...
for i in range(0,6):
    for j in range(0,6):
	    print('%.4f\t' % nltk.cluster.util.cosine_distance(centers[i], centers[j])),
    print('\n')
print(R)
