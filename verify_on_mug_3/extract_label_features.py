...
def extract_label_features(sess, image_dir_path, persons):
    ...
    count = 0
    for eye_image, label, person_name in get_example(image_dir_path):
...
def main(image_dir_path, sess=None, persons=PERSONS, result_dir='/home/tian/nemo_mug_results_3'):
    if sess is None:
        with tf.Session() as sess:
            person_features_dict = extract_label_features(sess, image_dir_path, persons)
